...
from wordtag.views import TagViewSet, WordViewSet, SpellinBloxPullHandler, DomainLocker, LogoutHandler, AuthChecker, SpellinBloxPushHandler
...
urlpatterns = [
    ...
    path('push_data', SpellinBloxPushHandler.run),
